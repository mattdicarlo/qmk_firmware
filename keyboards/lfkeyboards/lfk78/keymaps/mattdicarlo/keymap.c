...
enum keymap_layout {
    BASE = 0,     // Base layout, Mac OS modifiers
    FN,           // Function layer for Mac OS layout
    WIN,          // Toggled Windows layout
    WFN,          // Function layer for Windows layout
};
...
const Layer_Info layer_info[] = {
  ...
  {0x00000000, 0xFFFFFFFF, {0x05DF, 0x0CEF, 0x0BAF}}, // base layer
  {0x00000002, 0xFFFFFFFE, {0x06CF, 0x03BF, 0x07BF}}, // function layer
  {0x00000004, 0xFFFFFFFC, {0x0FFF, 0x0000, 0x0FFF}}, // windows layer
  {0x00000006, 0xFFFFFFF7, {0x0FFF, 0x0000, 0x0000}}, // windows function layer
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |---------|  |-------------------------------------------------------------------------.
   * |    |    |  |Ctrl|Alt |Cmd |      Space            |Cmd |Func|Ctrl |    |Lft| Dn |Rig |
   * `---------'  `------------------------------------------------------'    `-------------'
   */
  [BASE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX,  KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, MO(FN) , KC_RCTL,           KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |    |    |  |         |   |   |   |   |   |   |    |   |   |   |          |  |Vol+|
   * |---------|  |--------------------------------------------------------------------------.
   * |    |    |  |    |    |    |      Play/Pause        |    |Fn  |    |    |Prev|Vol-|Next|
   * `---------'  `------------------------------------------------------'    `--------------'
   */
  [FN] = LAYOUT(
    XXXXXXX, XXXXXXX, KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,           XXXXXXX, KC_PGUP, \
    XXXXXXX, XXXXXXX, TG(WIN), XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_MUTE, KC_PGDN,  \
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            KC_MPLY,                            XXXXXXX, _______, XXXXXXX,          KC_MRWD, KC_VOLD, KC_MFFD  \
  ),

  /* Keymap WIN: Toggleable Windows layout
   * ,---------.  ,------------------------------------------------------------.  ,---------.
   * |    |    |  |Esc~| 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |  0| - | = |Backspa|  | `  |Home|
   * |---------|  |------------------------------------------------------------|  |---------|
   * |    |    |  |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|     \|  | Del|End |
   ...
   * |    |    |  |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift      |  | Up |
   * |---------|  |-------------------------------------------------------------------------.
   * |    |    |  |Ctrl|Win |Alt |      Space            |Alt |Fn  |Ctrl |    |Lft| Dn |Rig |
   * `---------'  `------------------------------------------------------'    `-------------'
   */
  [WIN] = LAYOUT(
    XXXXXXX, XXXXXXX,  KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,   KC_BSPC,          KC_GRV,  KC_HOME, \
    ...
    XXXXXXX, XXXXXXX,  KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,                             \
    XXXXXXX, XXXXXXX,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSFT,          KC_UP,            \
    XXXXXXX, XXXXXXX,  KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(WFN), KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT  \
  ),

  /* Keymap WMN: Function Layer for Windows Layout
   * ,---------.  ,-------------------------------------------------------------.  ,---------.
   * |    |    |  |`  |F1 |F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|Delete   |  |    |PgUp|
   * |---------|  |-------------------------------------------------------------|  |---------|
   * |    |    |  |BASE |   | Up|   |   |   |   |   |   |   |   |   |   |       |  |Mute|PgDn|
  ...
  [WFN] = LAYOUT(
    XXXXXXX, XXXXXXX, KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,           XXXXXXX, KC_PGUP, \
    XXXXXXX, XXXXXXX, KC_FN0,  XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_MUTE, KC_PGDN,  \
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX,          XXXXXXX,                            \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX,                   XXXXXXX,          KC_VOLU,          \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            KC_MPLY,                            XXXXXXX, _______, XXXXXXX,          KC_MRWD, KC_VOLD, KC_MFFD  \
  ),
